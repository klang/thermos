...
get the app created:
    ...
    $ heroku apps:create thermos
    Creating thermos... done, stack is cedar
    http://thermos.herokuapp.com/ | git@heroku.com:thermos.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://thermos.herokuapp.com deployed to Heroku

    To git@heroku.com:thermos.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://thermos.herokuap.com
    ["Hello" :from Heroku]
...
[getting started with clojure](https://devcenter.heroku.com/articles/getting-started-with-clojure#prerequisites)
